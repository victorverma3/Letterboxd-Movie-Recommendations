...
const RecDisplay = ({ recommendations }: RecDisplayProps) => {
    return (
        <div className="max-h-128 overflow-y-scroll overflow-x-hidden w-fit max-w-5xl mt-4 mx-auto py-4 px-2 flex flex-wrap gap-4 justify-around border-2 border-gray-200 bg-palette-lightbrown">
