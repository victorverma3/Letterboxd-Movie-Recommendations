...
const RecDisplay = ({ recommendations }: RecDisplayProps) => {
    return (
        <div className="max-h-128 overflow-y-scroll overflow-x-hidden w-fit max-w-4/5 md:max-w-[700px] sm:w-full mx-auto py-4 px-2 flex flex-row flex-wrap gap-2 justify-evenly border-2 rounded-t-none border-gray-200 bg-palette-lightbrown">
